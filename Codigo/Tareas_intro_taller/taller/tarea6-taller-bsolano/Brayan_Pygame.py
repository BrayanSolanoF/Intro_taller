...
for i in range(50):
    ...
    bloque = Bloque(NEGRO, 20, 20,"clipart_goomba.png")
...
protagonista = Protagonista(ROJO, 30, 30,"mario.png")
...
while not hecho:
    ...
    scoretext=myfont.render("Score="+str(puntuacion),1,(0,0,0))
    pantalla.blit(scoretext,(5,10))
